...
#define abuff_raw(abuff)    ((char *)((abuff)->st))
#define abuff_craw(abuff)   ((const char *)((abuff)->cst))
#define abuff_uchar(abuff)   ((unsigned char *)((abuff)->ust))
#define abuff_cuchar(abuff)  ((const unsigned char *)((abuff)->ucst))
